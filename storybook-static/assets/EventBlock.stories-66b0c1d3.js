import{L as H}from"./Link-042bcafe.js";import{z as P,O as A,D as F,l as n,m as s,p as e,G as O,N as Y,n as l,C as u,A as h,J as z,H as G,I as J}from"./vue.esm-bundler-3c3b4f83.js";import{_ as U}from"./_plugin-vue_export-helper-c27b6911.js";import{V as j}from"./VTooltip-e8e2f6db.js";import"./VOverlay-139fd8f8.js";import"./locale-eae6cb20.js";import"./theme-43348865.js";import"./forwardRefs-188994b8.js";import"./anchor-a33efd51.js";import"./color-f66e96d0.js";import"./router-e0b4ace3.js";import"./display-34939fad.js";const D={name:"Calendar Event Block",components:{Link:H},props:{event:String},computed:{window:()=>window,hiddenEvents(){return this.events.length-3>0}},data:()=>({event:"",events:[{name:"Event 1",startTime:"10:00",endTime:"14:30"},{name:"Event 2",startTime:"10:00",endTime:"14:30"},{name:"Event 3",startTime:"10:00",endTime:"14:30"},{name:"Event 4",startTime:"10:00",endTime:"14:30"}]}),watch:{},methods:{onClick(){window.alert(event.name)}}},a=t=>(G("data-v-27d11f5f"),t=t(),J(),t),q={key:0},K={class:"date-wrapper booked"},M=a(()=>e("div",{class:"top-bar"},null,-1)),Q=a(()=>e("div",{class:"event-header"},[e("div",{class:"event-date"},"5")],-1)),R={class:"event-listing"},W=a(()=>e("span",null," - ",-1)),X={key:0,class:"additional-events"},Z={key:1},$=a(()=>e("div",{class:"date-wrapper today"},[e("div",{class:"top-bar"}),e("div",{class:"event-header"},[e("div",{class:"event-date"},"5")])],-1)),ee=[$],te={key:2},ne=a(()=>e("div",{class:"date-wrapper selected"},[e("div",{class:"top-bar"}),e("div",{class:"event-header"},[e("div",{class:"event-date"},"5")])],-1)),se=[ne],ae={key:3},oe=a(()=>e("div",{class:"date-wrapper empty"},[e("div",{class:"top-bar"}),e("div",{class:"event-header"},[e("div",{class:"event-date"},"5")])],-1)),re=[oe];function de(t,_,v,ie,ce,c){const I=P("Link"),V=A("switch");return F((n(),s("div",null,[v.event==="booked"?(n(),s("div",q,[e("div",K,[M,Q,(n(!0),s(O,null,Y(t.events.slice(0,3),m=>(n(),s("div",R,[e("a",{onClick:_[0]||(_[0]=(...L)=>c.onClick&&c.onClick(...L))},[e("h2",null,l(m.name),1),e("p",null,[u(l(m.startTime),1),W,u(l(m.endTime),1)])]),h(j)]))),256)),c.hiddenEvents?(n(),s("div",X,[e("p",null,"And "+l(c.hiddenEvents.extraEvents)+" more ",1),h(I,{text:"expand"})])):z("",!0)])])):v.event==="today"?(n(),s("div",Z,ee)):v.event==="highlighted"?(n(),s("div",te,se)):(n(),s("div",ae,re))])),[[V,t.events]])}const N=U(D,[["render",de],["__scopeId","data-v-27d11f5f"]]);D.__docgenInfo={displayName:"Calendar Event Block",exportName:"default",description:"",tags:{},props:[{name:"event",type:{name:"string"}}],sourceFiles:["/Users/chris/Desktop/HYYP/hyyp-storybook/src/components/Calendar/EventBlock.vue"]};const Be={component:N,title:"Calendar / Event Block"},p=t=>({components:{EventBlock:N},setup(){return{args:t}},template:'<EventBlock v-bind="args"/>'}),o=p.bind({});o.args={event:"empty"};const r=p.bind({});r.args={event:"booked"};const d=p.bind({});d.args={event:"today"};const i=p.bind({});i.args={event:"highlighted"};var g,k,E;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`args => ({
  components: {
    EventBlock
  },
  setup() {
...
//# sourceMappingURL=EventBlock.stories-66b0c1d3.js.map
