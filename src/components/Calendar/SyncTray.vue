<template>
    ...
    <div class="d-flex">
        <div class="last-time">
            <p>
                <!-- Should pe pulled from db -->
                Last Synced:<span>{{ lastUpdated }}</span>
            </p>
        </div>
        <div class="wrapper">
            <!-- Sync -->
            ...
            <!-- Share -->
            <button class="icon-btn" @click="$event => isModalOpen = !isModalOpen">
            <svg
